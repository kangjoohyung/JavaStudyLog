...
public class MainView {
	...
	public static void main(String[] args) {
		...
		BoardController.insertBoard("photo" ,  new PhotoBoard(40, "mvc공부", "장희정111", "재미있다.", "2018-08-18", "a.jpg"));
		System.out.println();
		
		System.out.println("--4-2. 등록하기(실패!! - 글번호 중복!)");
		BoardController.insertBoard("photo" , new PhotoBoard(10, "mvc공부", "장희정", "재미있다.", "2018-08-18", "a.jpg"));
		System.out.println();
		
		System.out.println("--4-2. 등록하기(실패!! - kind 잘못!!!!)");
		BoardController.insertBoard("photo2" ,  new PhotoBoard(50, "mvc공부", "장희정", "재미있다.", "2018-08-18", "a.jpg"));
	    System.out.println();
...
System.out.println("---6.수정하기----------------");
		...
		System.out.println("--6-1. photo수정 완료(제목, 작성자, 내용 , imgName)-----------------");
		BoardController.updateBoard(new PhotoBoard(10, "점심시간", "이효리", "뭐 먹지??", null, "test.gif") , "photo");
		System.out.println();
		
		System.out.println("--6-2. archive수정 완료(제목, 작성자, 내용, fileName, fileSize)-----------------");
...
//		
		...
		System.out.println("--6-2. archive수정 타입오류-----------------");
		BoardController.updateBoard(new ArchiveBoard(10, "점심시간", "이효리", "뭐 먹지??", null, "a.xls",300) , "photo");
		System.out.println();
		...
		System.out.println("2. kind-free에 해당하는 검색 ....");
		BoardController.getBoardByKind("free");
		
		System.out.println("3. kind-free의 10번 게시물 검색 ....");
		BoardController.getBoardByno("free",20);
		
		System.out.println("4. kind-free 등록하기 ");
		BoardController.insertBoard("free", new FreeBoard(30, "free추가", "삼순이", "잘되나?","2022-08-10", 3));
